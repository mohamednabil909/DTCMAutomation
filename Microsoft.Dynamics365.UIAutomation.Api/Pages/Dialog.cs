...
namespace Microsoft.Dynamics365.UIAutomation.Api
{
       ...
       : XrmPage
    {
        ...
        public BrowserCommandResult<bool> CloseWarningDialog(int Count)
        {
...

                    {
                        ...
                        if (inlineDialog)
                        {
                                  ...
                                  0))
                            {
                                 ...
                                 var closeBtn = driver.FindElement(By.XPath(Elements.Xpath[Reference.GuidedHelp.ButtonClose]));
                                try
                                {
                                    closeBtn.Click();
                                    return true;
                            ...
                            try
                            {
                                dialogFooter.FindElement(By.XPath(Elements.Xpath[Reference.Dialogs.WarningCloseButton])).Click();
                            }
                            catch (Exception)
                            {
                                // handle satle exception
